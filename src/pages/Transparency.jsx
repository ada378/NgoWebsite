...
const Transparency = () => {
  ...
  const quarterlyData = [{ month: 'Jan', education: 15, healthcare: 10, women: 5, environment: 3 }, { month: 'Feb', education: 18, healthcare: 12, women: 6, environment: 4 }, { month: 'Mar', education: 20, healthcare: 14, women: 7, environment: 5 }, { month: 'Apr', education: 22, healthcare: 15, women: 8, environment: 6 }]
  const documents = [
    ...
    <div>
      <section className="relative bg-black text-white py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-heading font-bold mb-4">Our Transparency</h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">Complete accountability. See exactly how your donation creates impact.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div key={i} className="bg-gray-900 rounded-2xl p-8 text-center border border-gray-800">
                ...
                <p className="font-display text-4xl font-bold text-secondary mb-2">{stat.value}</p>
          ...
          <div className="bg-gray-900 rounded-3xl p-8 md:p-12 border border-gray-800">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-3 text-white">Fund Allocation Breakdown</h2>
              <p className="text-gray-500">See exactly where every rupee goes</p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col justify-center space-y-4">
                {allocationData.map((item, i) => (
                  <div key={i} className="flex items-center space-x-4 p-4 bg-gray-800 rounded-xl border border-gray-700">
      ...
      <section className="py-20 bg-gray-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-3 text-white">Project-wise Spending</h2>
            <p className="text-gray-500">Detailed breakdown of funds allocated</p>
          </div>
          <div className="grid sm:grid-cols-2 gap-6">
            {data?.projects?.map((project, i) => (
              <div key={i} className="bg-gray-900 rounded-2xl p-6 flex items-start space-x-6 border border-gray-800">
                <div className={`w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 ${project.status === 'completed' ? 'bg-green-500/20' : 'bg-gray-800'}`}>
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-bold ${project.status === 'completed' ? 'bg-green-500/20 text-green-500' : 'bg-gray-800 text-gray-400'}`}>
                      {project.status.charAt(0).toUpperCase() + project.status.slice(1)}
                    </span>
                  </div>
                  <p className="font-display text-3xl font-bold text-secondary mb-1">₹{(project.amount / 100000).toFixed(1)}L</p>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold mb-3 text-white">Reports & Documents</h2>
            <p className="text-gray-500">Download financial reports and audit statements</p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {documents.map((doc, i) => (
              <div key={i} className="bg-gray-900 rounded-xl p-6 border border-gray-800 hover:border-secondary/50 transition-colors">
                ...
                <button className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-gray-800 border border-gray-700 text-gray-300 rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium">
      ...
      <section className="py-20 bg-gray-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Shield className="w-16 h-16 text-secondary mx-auto mb-6" />
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4 text-white">Our Promise to You</h2>
          <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">Complete transparency in all operations. Every donation tracked, every rupee accounted.</p>
          <div className="grid sm:grid-cols-3 gap-6 mb-12">
            {[
              ...
              <div key={i} className="bg-gray-900 backdrop-blur rounded-2xl p-8 border border-gray-800">
          ...
          <Link to="/donate" className="inline-flex items-center gap-2 px-8 py-4 bg-secondary text-black font-semibold rounded-xl hover:bg-yellow-400 transition-all">
            <span>Make a Difference</span><ExternalLink className="w-5 h-5" />
          </Link>
        </div>
      </section>
    </div>
